                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('judul.update', $item->id) }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="kemampuan-edit">Kemampuan</label>
                                                    <input type="text" class="form-control" id="kemampuan-edit"
                                                        name="kemampuan" value="{{ $item->kemampuan }}">
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('judul.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="judul-create"
                                                    name="judul" placeholder="Masukkan judul">
                                            </div>
                                            <div class="form-group">
                                                <label for="kemampuan-create">Kemampuan</label>
                                                <input type="text" class="form-control" id="kemampuan-create"
                                                    name="kemampuan" placeholder="Masukkan kemampuan">
                                            </div>
                                            <div class="form-group">
